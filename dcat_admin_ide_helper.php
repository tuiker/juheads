...
namespace Dcat\Admin {
     ...
     * @property Grid\Column|Collection location_image
     ...
     * @method Grid\Column|Collection location_image(string $label = null)
     ...
     * @property Show\Field|Collection location_image
     ...
     * @method Show\Field|Collection location_image(string $label = null)
